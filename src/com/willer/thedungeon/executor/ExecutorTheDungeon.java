...
public class ExecutorTheDungeon
{
   ...
   public static void main(String[] args)
   {
      ...
      //Este peda莽o de c贸digo 茅 s贸 para adiantar os testes
   ...
   private static void montarGrupo() throws MenuException
   {
      ...
      System.out.println("O grupo 茅 composto por 3 integrantes");
      ...
      do
      {
         ...
         switch (escolha)
         {
            ...
            case 0:
               ...
               break;
            default:
               throw new MenuException("Valor inv醠ido");
         }
   ...
   public static boolean executarBatalha(Grupo grupo, Vilao vilao)
   {
      ...
      while (grupo.isGrupoVivo() && vilao.isVivo())
      {
         if (turno == 0)
         {
            ...
            {
               System.out.println("O valor escolhido nao corresponde a um Personagem do grupo ou o Personagem escolhido est谩 morto");
            }
